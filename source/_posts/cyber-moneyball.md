...
屎山组每轮最先跑完所有测试。QG 组输掉了 17 轮，甚至无法完赛。我专门设计的技术债务惩罚关卡，远没有起到预想的作用。
...
**达夫设备（Duff's Device）**——Tom Duff 在 1983 年写出的这段代码，把 switch 语句和 do-while 循环交织在一起，利用 C 语言 case 穿透的特性实现循环展开。第一眼看上去像是编译器 bug，实际上是对指令流水线的极致压榨。任何 code review 工具都会把它标红：圈复杂度爆表、结构化设计全部违反、可读性约等于零。
...
感谢所有跟随这个系列到第五篇的同道中人，你们给的情绪价值是我继续写作分享的动力。在文章末尾，我把规则文件送给你们，希望这个规则文件也能帮你们省下账单、提高代码质量。
