...
- **可测试性**——你的意思是你们那些一个 Service 有二三十个 `@AutoWired` maybe `@Lazy` 的意大利面代码有可测试性？
...
感谢所有跟随这个系列到第五篇的同道中人，你们给的情绪价值是我继续写作分享的动力。在文章末尾，我把包含 harness 的 bench 框架送给你们，希望这个框架的核心原则也能帮你们省下账单、提高代码质量。

> **请注意**：该测试每个 agent 每轮会烧掉你 100-200 美金 Opus token。请谨慎在个人账户上复现，烧光了这周额度或者被 A 畜封号别怪我没提醒你。
